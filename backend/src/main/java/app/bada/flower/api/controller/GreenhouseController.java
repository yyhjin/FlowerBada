...
public class GreenhouseController {
    ...
    public ResponseEntity<ResponseDto> getMyRollingPapers(@RequestHeader(value = "X-AUTH-TOKEN") String token) {
        List<GreenhouseResDto> rollingPapers = greenhouseService.getMyRollingPapers(token);

        if (rollingPapers != null) {
    ...
    public ResponseEntity<ResponseDto> getMyBookmarks(@RequestHeader(value = "X-AUTH-TOKEN") String token) {
        List<GreenhouseResDto> rollingPapers = greenhouseService.getMyBookmarks(token);
